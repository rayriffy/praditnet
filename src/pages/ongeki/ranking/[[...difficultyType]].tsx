...
import { MusicListingProps } from '../../../modules/ongeki/ranking/components/MusicListing'

import { Difficulty } from '../../../modules/ongeki/ranking/@types/Difficulty'
import { AppProps } from '../../../app/@types/AppProps'

const MusicListing = dynamic<MusicListingProps>(
  () =>
    import('../../../modules/ongeki/ranking/components/MusicListing').then(
      o => o.MusicListing
    ),
  { ssr: false }
)
    ...
    <div className="mt-4">
      ...
      <div className="my-4 grid gap-1 sm:gap-4 grid-cols-2 sm:grid-cols-4 max-w-xl mx-auto">
        {difficulties.map(difficulty => (
          <Link
            href={`/ongeki/ranking/${difficulty.key}`}
...
export const getServerSideProps: GetServerSideProps<Props> = async ctx => {
  ...
  const { difficulties } = await import(
    '../../../modules/ongeki/ranking/constants/difficulties'
  )
  const { getGrouppedMusics } = await import(
    '../../../modules/ongeki/ranking/services/getGrouppedMusics'
  )
