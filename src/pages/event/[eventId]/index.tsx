    ...
    <div className="space-y-4">
      ...
      <div className="space-x-4 flex justify-center">
        <a
          ...
          className="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-neutral-700 dark:text-white dark:hover:bg-neutral-600"
        >
          Event details
        </a>
        <Link href={`/event/${event.id}/leaderboard`}>
          <a className="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-neutral-700 dark:text-white dark:hover:bg-neutral-600">
            Leaderboard
          </a>
        </Link>
      </div>
